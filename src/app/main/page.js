    ...
    <div className='w-screen z-20'>
        ...
        <div className='w-screen h-20 flex justify-between mb-6'>
            ...
            <button
              ...
              className="flex my-6 items-center justify-center w-[150px] h-[50px] rounded-[30px] border border-gray-400 text-white font-dmSans font-bold text-lg"
              >
              Call
            </button>
              </Link>
        ...
        <div className='flex justify-center items-center text-white text-5xl font-dmSans font-bold mt-8'>You Are Safe Till You're Here</div>
        <div className='flex justify-center items-center text-gray-300 text-lg font-dmSans mt-3'>Your Guardian knows you're on an Unknown Call</div>
        
        <div
      className="flex justify-between font-dmSans border-2 h-[115px] mt-40 w-[1000px] mx-auto border-[rgba(75,30,133,0.5)] rounded-[1.5em] bg-gradient-to-br from-[rgba(75,30,133,1)] to-[rgba(75,30,133,0.01)] text-white font-nunito p-[1em] backdrop-blur-[12px]"
    >
      <div>
        <h1 className="text-[2em] font-bold">Request Your Docs</h1>
        <p className="text-[0.85em]">
          Your Guardian will provide access to Your Docs
        </p>
      </div>
      ...
      >
        ...
        <div className='flex justify-center items-center text-white text-5xl font-dmSans font-bold mt-56'>Send Your Location</div>
        ...
        <div class="bg-white w-[1000px] h-64 mx-auto my-16 rounded-lg">
            ...
            <div class="card__content">
              ...
              <div className='w-28 mx-auto mt-10'>
                <div className="relative inline-block">
                  <button className="primary-button relative z-10 text-white font-bold tracking-wide border border-[#0E1822] px-8 py-3 bg-[url('data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 531.28 200%27%3E%3Cdefs%3E%3Cstyle%3E .shape %7B fill: %23FF4655 %7D %3C/style%3E%3C/defs%3E%3Cg id=%27Layer_2%27 data-name=%27Layer 2%27%3E%3Cg id=%27Layer_1-2%27 data-name=%27Layer 1%27%3E%3Cpolygon class=%27shape%27 points=%27415.81 200 0 200 115.47 0 531.28 0 415.81 200%27 /%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] bg-[#0E1822] bg-[200%] bg-no-repeat bg-left transition-all duration-300 ease-in-out hover:bg-[#FF4655] hover:border-[#FF4655]">
                    <a href="https://sancharsaathi.gov.in/sfc/">Report</a>
                  </button>
                  <div className="absolute inset-0 border-t border-l border-[#0E1822] h-1/2 -top-1.5 -left-1.5"></div>
                  <div className="absolute inset-0 border-b border-r border-[#0E1822] h-1/2 -bottom-1.5 -right-1.5"></div>
                </div>
